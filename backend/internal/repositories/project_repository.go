...
func (r *projectRepository) Create(ctx context.Context, project *models.Project) error {
	...
	`
	err := r.db.QueryRow(ctx, query, project.Name, project.Description, project.Status, project.Stack, project.RepositoryURL, project.DeploymentURL, project.UserID).Scan(&project.ID, &project.UUID, &project.CreatedAt, &project.UpdatedAt)
	if err != nil {
		return err
	}
	return nil
